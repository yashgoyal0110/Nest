    ...
    >
      <div className="flex w-full flex-col items-start gap-1.5">
        <div className="flex w-full items-center gap-2">
          ...
          {/* Project Title */}
          <Link href={url} target="_blank" rel="noopener noreferrer" className="group w-full flex-1 no-underline">
      ...
      <div className={hasSocial ? "flex w-full flex-col gap-2 pr-4" : "flex w-full items-center justify-between"}>
        {/* Footer section */}
        {hasSocial ? (
                ...
                <div className="flex flex-wrap">
                  {social.map((item) => (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mr-2 flex h-7 w-7 items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-colors hover:bg-blue-100 hover:text-blue-600 dark:bg-slate-700 dark:text-gray-300 dark:hover:bg-blue-900 dark:hover:text-blue-300 sm:h-8 sm:w-8"
                    >
